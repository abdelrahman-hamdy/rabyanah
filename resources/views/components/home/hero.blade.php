...
<section id="home" class="relative min-h-screen lg:min-h-[max(100vh,820px)] overflow-hidden">
    ...
    <!-- Scroll Indicator -->
    <a href="#featured"
       class="absolute left-1/2 -translate-x-1/2 flex flex-col items-center text-gray-400 hover:text-rabyanah-blue-600 transition-colors hero-cta"
       style="bottom: -44px; animation-delay: 1.2s;">
